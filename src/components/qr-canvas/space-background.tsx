 ...
 * Utilizing hardware acceleration (translateZ) to ensure smooth scrolling 
 * when heavy blurs and radial gradients are active in the viewport.
 */
export function SpaceBackground() {
  return (
    <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden" aria-hidden="true" style={{ transform: 'translateZ(0)' }}>
      ...
      {/* High-Contrast Depth Glows with GPU Acceleration */}
      <div 
