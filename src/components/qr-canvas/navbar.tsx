...
const SEARCHABLE_TOOLS = [
  ...
  { href: '/nickname-generator', title: 'Nickname Studio', icon: Wand2, label: 'IDENTITY', keywords: ['gamertag', 'alias', 'brand name'] },
  { href: '/lorem-ipsum-generator', title: 'Lorem Ipsum', icon: AlignLeft, label: 'TYPOGRAPHY', keywords: ['lorem ipsum', 'placeholder', 'dummy text', 'filler'] },
  ...
  { href: '/ocr', title: 'OCR Extraction', icon: FileText, label: 'INTEL', keywords: ['ocr', 'text', 'read'] },
  { href: '/pdf-merger', title: 'PDF Merger', icon: FileStack, label: 'DOCUMENT', keywords: ['merge', 'pdf', 'combine'] },
  { href: '/pdf-compressor', title: 'PDF Compressor', icon: FileArchive, label: 'OPTIMIZE', keywords: ['shrink', 'smaller', 'kb'] },
  { href: '/video-to-audio', title: 'Video to MP3', icon: Music, label: 'MEDIA', keywords: ['mp3', 'extract', 'audio'] },
