          ...
          <Card className="glass-card border-border shadow-2xl overflow-hidden">
            <CardHeader className="pb-8 border-b border-border bg-secondary/30">
              <div className="flex justify-between items-center">
                ...
                <div className="px-3 py-1 rounded-lg bg-secondary border border-border text-[10px] font-black text-primary uppercase tracking-widest">
            ...
            <CardContent className="pt-10 space-y-8">
              <Textarea 
                ...
                className="min-h-[160px] bg-secondary border-border text-lg rounded-3xl focus:ring-primary/40 p-6 text-foreground font-mono leading-relaxed resize-none transition-all"
              />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="h-12 rounded-xl border border-border bg-background text-[10px] font-black uppercase tracking-widest text-foreground/50 hover:text-primary hover:border-primary/40 transition-all active:scale-95"
                  >
                    {btn.label}
                  </button>
                ))}
            ...
            <CardContent className="pt-10 space-y-8">
              <div className="relative group">
                <Textarea 
                  ...
                  className="min-h-[300px] bg-white dark:bg-black/20 border-border text-foreground font-mono rounded-[2.5rem] p-8 text-lg leading-relaxed resize-none shadow-inner custom-scrollbar"
                />
                {!output && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center opacity-10 group-hover:opacity-20 transition-opacity">
                    ...
                    <p className="text-xs font-black uppercase tracking-[0.3em]">Ready for input</p>
                  </div>
                )}
              </div>
