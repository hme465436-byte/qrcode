...
/**
 * DECOMMISSIONED TOOL: Chat Studio
 * This tool has been definitively removed from the MY KIT TOOL registry.
 * Users are automatically redirected to the primary dashboard.
 */
export default function DecommissionedPage() {
  const router = useRouter();

  useEffect(() => {
    // Hardware-timed redirect matrix
